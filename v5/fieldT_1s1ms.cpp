...
double field::f_x(double xx, double yy, vector<double> x0_bias)
{
	...
	return f_LJ(xx, epsilon, sigma) + f_Gaussian(xx, 0.3, 1.75, 0.2)+ f_bias(xx, h_bias, x0_bias, w_bias);
...
double field::f_x(double xx, double yy, vector<double> x0_bias, vector<double> h0_bias)
{
	...
	return f_LJ(xx, epsilon, sigma) + f_Gaussian(xx, 0.3, 1.75, 0.2) + f_bias_wt(xx, h_bias, x0_bias, w_bias, delta_beta);
...
double field::f_x(double xx, double yy, vector<double> x0_bias, vector<double> y0_bias, vector<double> h0_bias)
{
	...
	return f_LJ(xx, epsilon, sigma) + f_Gaussian(xx, 0.3, 1.75, 0.2) + coeff_x*f_bias(xx, yy, h_bias, x0_bias, y0_bias, w_bias, delta_beta, h0_bias, coeff_x, coeff_y);
