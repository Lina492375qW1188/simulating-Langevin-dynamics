...
double field::f_x(double xx, double yy)
{
	...
	- f_Gaussian(xx, A, 1.5, width)*pe_Gaussian(yy, A, 1.8, width)  \
	- f_Gaussian(xx, A, 0.0, width)*pe_Gaussian(yy, A, -1.0, width) \
	- f_Gaussian(xx, A, -1.5, width)*pe_Gaussian(yy, A, 1.5, width);
...
{	
	...
	- pe_Gaussian(xx, A, 1.5, width)*f_Gaussian(yy, A, 1.8, width)  \
	- pe_Gaussian(xx, A, 0.0, width)*f_Gaussian(yy, A, -1.0, width) \
	- pe_Gaussian(xx, A, -1.5, width)*f_Gaussian(yy, A, 1.5, width);
