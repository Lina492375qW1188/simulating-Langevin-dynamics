...
double field::f_x(double xx, double yy)
{
	...
	return -6*(xx*xx*xx*xx*xx) \
	+ f_Gaussian(xx, hx, x0, width_x)*(1-pe_Gaussian(yy, hy, y0, width_y));
...
{	
	...
	return -6*(yy*yy*yy*yy*yy) \
	+ pe_Gaussian(xx, hx, x0, width_x)*(-f_Gaussian(yy, hy, y0, width_y));
}
