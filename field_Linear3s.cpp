...
double field::f_x(double xx, double yy)
{
	...
	return -0.0006*(xx*xx*xx*xx*xx) - f_Gaussian(xx, A, 1.5, width)*pe_Gaussian(yy, A, 1.5, width)  - f_Gaussian(xx, A, 0.0, width)*pe_Gaussian(yy, A, 0.0, width) - f_Gaussian(xx, A, -1.5, width)*pe_Gaussian(yy, A, -1.5, width);
...
{	
	...
	return -0.0006*(yy*yy*yy*yy*yy) - pe_Gaussian(xx, A, 1.5, width)*f_Gaussian(yy, A, 1.5, width) - pe_Gaussian(xx, A, 0.0, width)*f_Gaussian(yy, A, 0.0, width)- pe_Gaussian(xx, A, -1.5, width)*f_Gaussian(yy, A, -1.5, width);
